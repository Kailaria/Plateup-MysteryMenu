...
{
    public class MysterySandwichToastLettuceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Lettuce topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Lettuce",
