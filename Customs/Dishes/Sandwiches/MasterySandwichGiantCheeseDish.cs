...
{
    public class MasterySandwichGiantCheeseDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Giant - Cheese filling";
        public override Dish OrigDish => (Dish)GDOUtils.GetExistingGDO(References.SandwichCheeseDish);
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sandwich</i>, Cheese\n" + 
                "Chop and serve cheese when requested as a filling for a Sandwich, Giant Sandwich, or Toast Sandwich." }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                Name = "Mastery - Sandwich Cheese Extra",
                Description = "Adds <b>Cheese</b> as an ingredient for all types of Sandwiches when it's present with <b>FLour</b> and " +
