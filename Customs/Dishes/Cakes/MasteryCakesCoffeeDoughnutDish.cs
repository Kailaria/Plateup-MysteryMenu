...
{
    public class MasteryCakesCoffeeDoughnutDish : GenericMasteryDish
    {
        protected override string NameTag => "Cake - Coffee Doughnut";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color> Doughnut tray (tray), Flour, Egg, Sugar, Milk, Oil, Coffee\n" +
                ...
                "Brew a cup of coffee. Portion the cooked doughnut from the pot, then combine with the coffee and serve to customers " +
                $"ordering coffee flavour {References.PinkTintCakesText} for dessert."
            }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Cakes - Coffee Doughnut",
                Description = "Adds coffee doughnuts as a dessert when flour, egg, sugar, milk, oil, coffee, and a doughnut tray are present",
