...
{
    public class MysterySundaeCherryDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sundae - Cherry topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sundae - Cherry topping",
