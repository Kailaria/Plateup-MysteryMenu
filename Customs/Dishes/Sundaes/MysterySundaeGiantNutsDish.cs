...
{
    public class MysterySundaeGiantNutsDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sundae Giant - Nuts topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Giant Sundae - Nuts topping",
