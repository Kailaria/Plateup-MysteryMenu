...
{
    public class MasterySundaeGiantCherryDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sundae Giant - Cherry topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Giant Sundae - Cherry topping",
