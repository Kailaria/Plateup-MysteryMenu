...
{
    public class MysterySandwichHamSliceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Ham Slice topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Ham Slice",
