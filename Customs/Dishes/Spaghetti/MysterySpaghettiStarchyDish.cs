...
{
    public class MysterySpaghettiStarchyDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Spaghetti - Extra Starchy Variant";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Spaghetti - Extra Starch",
