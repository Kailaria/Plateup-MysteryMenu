...
{
    public class MasterySundaeVanillaIceCreamDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sundae - Vanilla Ice Cream ingredient";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sundae - Vanilla Ice Cream",
