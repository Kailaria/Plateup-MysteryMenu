...
{
    public class MasteryHotdogKetchupDish : GenericMasteryDish
    {
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Hot Dog - Extra Ketchup",
        ...
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish)GDOUtils.GetCustomGameDataObject<MasteryHotdogBaseDish>();
    }
}
