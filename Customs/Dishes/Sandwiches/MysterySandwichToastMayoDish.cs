...
{
    public class MysterySandwichToastMayoDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Mayo filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Mayo Extra",
