...
namespace KitchenMasteryMenu.Customs.Dishes.Pies
{
    public class MasteryPiesVegetableDish : GenericMasteryDish
    {
        ...
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish) GDOUtils.GetCustomGameDataObject<MasteryPiesBaseDish>();
    }
}
