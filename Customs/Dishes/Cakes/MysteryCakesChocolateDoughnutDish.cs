...
{
    public class MysteryCakesChocolateDoughnutDish : GenericMysteryDish
    {
        protected override string NameTag => "Cake - Chocolate Doughnut";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color> Doughnut tray (tray), Flour, Egg, Sugar, Milk, Oil, Chocolate\n" +
                ...
                "Melt (cook) some chocolate. Portion the cooked doughnut from the pot, then combine with the melted chocolate and serve to customers " +
                $"ordering chocolate flavour {References.PinkTintCakesText} for dessert."
            }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Cakes - Chocolate Doughnut",
                Description = "Adds chocolate doughnuts as a dessert when flour, egg, sugar, milk, oil, chocolate, and a doughnut tray are present",
