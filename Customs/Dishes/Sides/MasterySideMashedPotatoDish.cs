...
namespace KitchenMasteryMenu.Customs.Dishes.Sides
{
    public class MasterySideMashedPotatoDish : GenericMasteryDish
    {
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Side - Mashed Potato",
        ...
        {
            GDOUtils.GetCastedGDO<Dish, MasteryMenuSidesDish>()
        };
