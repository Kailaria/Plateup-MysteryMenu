...
namespace KitchenMasteryMenu.Customs.Dishes.Dumplings
{
    public class MasteryDumplingsSoySauceDish : GenericMasteryDish
    {
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Dumplings - Soy Sauce",
        ...
        {
            GDOUtils.GetCastedGDO<Dish, MasteryMenuCondimentsDish>()
        };
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish)GDOUtils.GetCustomGameDataObject<MasteryDumplingsBaseDish>();
    }
}
