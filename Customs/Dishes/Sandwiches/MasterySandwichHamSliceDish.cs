...
{
    public class MasterySandwichHamSliceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Ham Slice topping";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sandwich</i>, Ham Slice\n" + 
                "Serve when requested between slices of bread/toast." }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                Name = "Mastery - Sandwich Ham Slice",
                Description = "Adds <b>Ham Slices</b> as an ingredient for all types of Sandwiches when it's present with <b>FLour</b>",
        ...
        public override HashSet<Dish.IngredientUnlock> IngredientsUnlocks => new()
        {
            new()
            {
                ...
                Ingredient = (Item)GDOUtils.GetExistingGDO(References.HamSliced)
            }
        };
        public override HashSet<Item> MinimumRequiredMasteryIngredients => new HashSet<Item>()
        {
            (Item) GDOUtils.GetExistingGDO(ItemReferences.Flour),
            (Item) GDOUtils.GetExistingGDO(References.HamSliced)
        };
