...
{
    public class MasterySandwichGiantEggDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Giant - Egg filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Giant - Egg Extra",
