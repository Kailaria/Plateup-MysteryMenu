...
{
    public class MasterySpaghettiLasagneDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Lasagne Dish";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color> Lasagne Tray (Tray), Lasagne Pasta Sheets, Butter, Flour, Milk, Mince, Tomato\n" +
