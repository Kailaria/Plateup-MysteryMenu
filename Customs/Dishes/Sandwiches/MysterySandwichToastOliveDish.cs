...
{
    public class MysterySandwichToastOliveDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Olive topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Olive Topper",
