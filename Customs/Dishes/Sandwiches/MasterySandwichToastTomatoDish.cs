...
{
    public class MasterySandwichToastTomatoDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Tomato topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Tomato",
