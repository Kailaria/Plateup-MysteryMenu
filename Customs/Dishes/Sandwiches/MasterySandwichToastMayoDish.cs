...
{
    public class MasterySandwichToastMayoDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Mayo filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Mayo Extra",
