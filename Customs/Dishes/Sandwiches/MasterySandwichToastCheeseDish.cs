...
{
    public class MasterySandwichToastCheeseDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Toast - Cheese filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Toast Sandwich - Cheese Extra",
