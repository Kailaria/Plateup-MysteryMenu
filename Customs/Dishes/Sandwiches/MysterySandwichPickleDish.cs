...
{
    public class MysterySandwichPickleDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Pickle topper";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sandwich</i>, Pickle\n" + 
                "Serve pickle when requested as a topper for a Sandwich, Giant Sandwich, or Toast Sandwich." }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                Name = "Mystery - Sandwich Pickle Topper",
                Description = "Adds <b>Pickle</b> as an ingredient for all types of Sandwiches when it's present with <b>FLour</b> and " +
        ...
        public override HashSet<Dish.IngredientUnlock> IngredientsUnlocks => new()
        {
            new()
            {
                ...
                Ingredient = (Item)GDOUtils.GetExistingGDO(References.Pickle)
            }
        };
        public override HashSet<Item> MinimumRequiredMysteryIngredients => new HashSet<Item>()
        {
            (Item) GDOUtils.GetExistingGDO(References.Pickle)
        };
