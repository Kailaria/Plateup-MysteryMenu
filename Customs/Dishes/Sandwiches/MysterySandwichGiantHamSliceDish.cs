...
{
    public class MysterySandwichGiantHamSliceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Giant - Ham Slice topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Giant - Ham Slice",
