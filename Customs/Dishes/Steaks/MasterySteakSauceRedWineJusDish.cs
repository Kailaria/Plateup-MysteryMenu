...
{
    public class MasterySteakSauceRedWineJusDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Steak - Red Wine Jus Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Steak Sauce - Red Wine Jus",
