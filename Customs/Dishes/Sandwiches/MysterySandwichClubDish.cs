...
{
    public class MysterySandwichClubDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Club Dish";
        ...
        public override Dictionary<Locale, string> Recipe => new()
        {
            { Locale.English,
                ...
                "Portion 3 Bread Slices and cook to make Toast. Chop Lettuce & Tomato as requested. Chop Egg and combine with Oil to make Mayo as requested.\n" +
