...
{
    public class MasterySandwichEggDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Egg filling";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sandwich</i>, Egg\n" + 
                "Chop and cook an egg to serve when requested as a filling for a Sandwich, Giant Sandwich, or Toast Sandwich." }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                Name = "Mastery - Sandwich Egg Extra",
