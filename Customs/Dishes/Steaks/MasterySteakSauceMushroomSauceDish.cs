...
{
    public class MasterySteakSauceMushroomSauceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Steak - Mushroom Sauce Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Steak Sauce - Mushroom Sauce",
