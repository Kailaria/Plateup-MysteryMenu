...
{
    public class MysterySandwichGiantPickleDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Giant - Pickle topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Giant - Pickle Topper",
