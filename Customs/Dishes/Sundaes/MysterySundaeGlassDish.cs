...
{
    public class MysterySundaeGlassDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sundae - Sundae Glass ingredient";
