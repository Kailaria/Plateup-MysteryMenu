...
{
    public class MasterySandwichOliveDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Olive topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Olive Topper",
