...
{
    public class MysterySandwichBreadDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Bread ingredient";
