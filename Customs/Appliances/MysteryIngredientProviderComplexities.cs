...
{
    public class MysteryIngredientProviderComplexities : MysteryIngredientProvider
    {
        public override string UniqueNameID => "Mystery Ingredient Provider Complexities";
