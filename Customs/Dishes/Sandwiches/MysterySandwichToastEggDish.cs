...
{
    public class MysterySandwichToastEggDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Egg filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Egg Extra",
