...
{
    public class MasterySandwichToastHamSliceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Ham Slice topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Ham Slice",
