...
{
    public class MasterySandwichTomatoDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Tomato topping";
