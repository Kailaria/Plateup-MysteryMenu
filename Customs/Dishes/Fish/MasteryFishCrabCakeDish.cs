...
namespace KitchenMasteryMenu.Customs.Dishes.Fish
{
    public class MasteryFishCrabCakeDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Fish Crab Cake Dish";
