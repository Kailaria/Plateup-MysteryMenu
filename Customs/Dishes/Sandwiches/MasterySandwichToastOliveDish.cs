...
{
    public class MasterySandwichToastOliveDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Olive topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Olive Topper",
