...
{
    public class MasteryStirFryBroccoliDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Stir Fry Broccoli Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Stir Fry Broccoli",
