...
{
    public class MasterySandwichGiantTomatoDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Giant - Tomato topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Giant - Tomato",
