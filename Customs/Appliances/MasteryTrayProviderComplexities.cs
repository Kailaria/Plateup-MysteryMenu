...
{
    public class MasteryTrayProviderComplexities : CustomAppliance
    {
        public override string UniqueNameID => "Mastery Tray Provider 2";
        public override GameObject Prefab => ((Appliance) GDOUtils.GetExistingGDO(ApplianceReferences.SourceDoughnutTray)).Prefab;
        ...
        public override List<Appliance.ApplianceProcesses> Processes => 
            ((Appliance) GDOUtils.GetExistingGDO(ApplianceReferences.SourceDoughnutTray)).Processes.ToList();
