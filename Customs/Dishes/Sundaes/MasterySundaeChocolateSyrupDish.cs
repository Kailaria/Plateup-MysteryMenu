...
{
    public class MasterySundaeChocolateSyrupDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sundae - Chocolate Syrup ingredient";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sundae</i>, Chocolate Syrup\n" + 
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sundae - Chocolate Syrup",
