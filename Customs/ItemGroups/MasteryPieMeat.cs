...
{
    public class MasteryPieMeatRaw : GenericMasteryItemGroup
    {
        protected override string NameTag => "Mastery Pie - Meat Raw";
    ...
    public class MasteryPieMeatRawBlindBaked : GenericMasteryItemGroup
    {
        protected override string NameTag => "Mastery Pie - Meat Raw - Blind Baked";
