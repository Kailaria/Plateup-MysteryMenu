...
namespace KitchenMasteryMenu.Customs.Dishes.Pizza
{
    public class MasteryPizzaMushroomDish : GenericMasteryDish
    {
        ...
        {
            GDOUtils.GetCastedGDO<Dish, MasteryMenuVeggieVariationsDish>()
        };
        ...
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish) GDOUtils.GetCustomGameDataObject<MasteryPizzaBaseDish>();
    }
}
