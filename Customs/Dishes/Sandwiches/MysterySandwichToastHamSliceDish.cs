...
{
    public class MysterySandwichToastHamSliceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Ham Slice topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Ham Slice",
