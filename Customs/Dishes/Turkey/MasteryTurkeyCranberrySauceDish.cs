...
{
    public class MasteryTurkeyCranberrySauceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Turkey Cranberry Sauce Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Turkey - Cranberry Sauce",
        ...
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish)GDOUtils.GetCustomGameDataObject<MasteryTurkeyBaseDish>();
        public override MenuPhase MenuPhase => BaseMasteryDish.MenuPhase;
    }
}
