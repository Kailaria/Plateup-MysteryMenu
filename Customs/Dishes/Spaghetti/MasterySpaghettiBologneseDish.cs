...
{
    public class MasterySpaghettiBologneseDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Spaghetti Bolognese Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Spaghetti Bolognese",
