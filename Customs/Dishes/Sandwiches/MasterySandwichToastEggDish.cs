...
{
    public class MasterySandwichToastEggDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Egg filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Egg Extra",
