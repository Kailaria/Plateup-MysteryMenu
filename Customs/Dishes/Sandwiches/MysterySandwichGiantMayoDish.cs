...
{
    public class MysterySandwichGiantMayoDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Giant - Mayo filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Giant - Mayo Extra",
