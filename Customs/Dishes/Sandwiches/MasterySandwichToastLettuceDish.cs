...
{
    public class MasterySandwichToastLettuceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Lettuce topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Lettuce",
