...
{
    public class MasterySandwichToastPickleDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast - Pickle topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Toast - Pickle Topper",
