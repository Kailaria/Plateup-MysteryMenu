...
{
    public class MasterySandwichGiantBreadDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Giant - Bread ingredient";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Giant Sandwich - Bread",
