...
{
    public class MysterySandwichToastPickleDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Pickle topper";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Pickle Topper",
