...
{
    public class MasterySandwichGiantHamSliceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Giant - Ham Slice topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sandwich Giant - Ham Slice",
