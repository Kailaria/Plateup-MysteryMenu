...
{
    public class MasterySundaeStrawberryIceCreamDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sundae - Strawberry Ice Cream ingredient";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sundae</i>, Strawberry Ice Cream\n" + 
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Sundae - Strawberry Ice Cream",
