...
{
    public class MysterySundaeChocolateIceCreamDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sundae - Chocolate Ice Cream ingredient";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sundae - Chocolate Ice Cream",
