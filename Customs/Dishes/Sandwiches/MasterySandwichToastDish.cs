...
{
    public class MasterySandwichToastDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich Toast Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                ...
                Description = "Adds toast sandwiches as a main dish when <b>flour</b> and one other base sandwich ingredient (ham slices, lettuce, or tomato) are present",
        ...
        public override List<Dish.MenuItem> ResultingMenuItems => new()
        {
            new()
            {
                Item = (Item) GDOUtils.GetExistingGDO(References.SandwichToastPiecemeal),
        ...
        {
            GDOUtils.GetCastedGDO<Dish, MasteryMenuCarnivoreVariationsDish>()
        };
    }
}
