...
namespace KitchenMasteryMenu.Customs.Dishes.Steaks
{
    public class MasterySteakThickDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Thick Steak Dish";
