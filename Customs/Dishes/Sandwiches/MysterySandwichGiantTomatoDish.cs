...
{
    public class MysterySandwichGiantTomatoDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Giant - Tomato topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Giant - Tomato",
