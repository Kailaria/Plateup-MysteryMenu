...
{
    public class MysterySandwichGiantLettuceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Giant - Lettuce topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Giant - Lettuce",
