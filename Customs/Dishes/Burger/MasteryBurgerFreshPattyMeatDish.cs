...
namespace KitchenMasteryMenu.Customs.Dishes.Burger
{
    public class MasteryBurgerFreshPattyMeatDish : GenericMasteryDish
    {
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Burger - Fresh Patties (Meat)",
        ...
        public override GenericMasteryDish BaseMasteryDish => (GenericMasteryDish)GDOUtils.GetCustomGameDataObject<MasteryBurgerBaseDish>();
    }
}
