...
{
    public class MysterySundaeGiantVanillaIceCreamDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sundae Giant - Vanilla Ice Cream ingredient";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Giant Sundae - Vanilla Ice Cream",
