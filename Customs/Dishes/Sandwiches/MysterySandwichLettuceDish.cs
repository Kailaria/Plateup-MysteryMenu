...
{
    public class MysterySandwichLettuceDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Lettuce topping";
        ...
        {
            { Locale.English,
                "<color=yellow>Requires ingredients:</color>  <i>Sandwich</i>, Lettuce\n" + 
                "Chop lettuce and serve when requested between slices of bread/toast." }
        };
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            (Locale.English, new UnlockInfo()
            {
                Name = "Mystery - Sandwich Lettuce",
