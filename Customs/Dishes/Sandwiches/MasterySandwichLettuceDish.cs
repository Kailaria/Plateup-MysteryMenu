...
{
    public class MasterySandwichLettuceDish : GenericMasteryDish
    {
        protected override string NameTag => "Mastery Sandwich - Lettuce topping";
