...
{
    public class MysterySandwichToastCheeseDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Toast - Cheese filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Toast Sandwich - Cheese Extra",
