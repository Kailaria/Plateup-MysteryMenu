...
{
    public class MysterySandwichGiantCheeseDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich - Giant - Cheese filling";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Cheese Extra",
