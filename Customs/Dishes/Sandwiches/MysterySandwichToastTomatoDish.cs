...
{
    public class MysterySandwichToastTomatoDish : GenericMysteryDish
    {
        protected override string NameTag => "Mystery Sandwich Toast - Tomato topping";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mystery - Sandwich Toast - Tomato",
