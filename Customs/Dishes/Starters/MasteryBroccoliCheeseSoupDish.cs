...
namespace KitchenMasteryMenu.Customs.Dishes.Starters
{
    public class MasteryBroccoliCheeseSoupDish : GenericMasteryDish
    {
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new()
        {
            ...
            {
                Name = "Mastery - Starter - Broccoli Cheese Soup",
